...
import { FileHeart, Home, Pill, Scissors, Syringe, Users, ChevronLeft, ChevronRight, Menu } from "lucide-react"
...
const menuItems = [
  ...
  { href: "/historial-clinico", label: "Historial Clínico", icon: FileHeart },
